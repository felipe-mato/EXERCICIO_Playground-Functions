...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-027-b-project-playground-functions.git`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-027-b-project-playground-functions/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-027-b-project-playground-functions/pulls) e confira que o seu _Pull Request_ está criado
